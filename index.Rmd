...
---
### Data
We chose to analyze the New York Restaurant Inspection Result data set, which includes the sanitiation ratings, scores, and infractions for the various restaurants around the city. The data was cleaned and manipulated to be accessible for analysis.
